...
public class Slapshot extends Frame implements ActionListener, MouseListener, MouseMotionListener, Runnable 
{
    ...
    Slapshot() 
    {
        ...
        backGroundImage = new ImageIcon(this.getClass().getResource("rink.gif")).getImage();
        tracker.addImage(backGroundImage, 0);
    
        gifImages[0] = new ImageIcon(this.getClass().getResource("puck.gif")).getImage();
        tracker.addImage(gifImages[0], 0);

        gifImages[1] = new ImageIcon(this.getClass().getResource("blocker.gif")).getImage();
